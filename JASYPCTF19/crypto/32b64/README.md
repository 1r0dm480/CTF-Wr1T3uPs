...
## Writeup
```bash
root@1v4n:~/CTF/JASYPCTF2019/crypto/32b64# file cipher.txt
cipher.txt: ASCII text, with very long lines
root@1v4n:~/CTF/JASYPCTF2019/crypto/32b64# md5sum cipher.txt
f953668ed88f5954effb20bf6c19484a  cipher.txt
root@1v4n:~/CTF/JASYPCTF2019/crypto/32b64# cat cipher.txt
...
root@1v4n:~/CTF/JASYPCTF2019/crypto/32b64# nano get_flag.sh
...
root@1v4n:~/CTF/JASYPCTF2019/crypto/32b64# ./get_flag.sh
